...
console.log(`3.-------------------Employee Start with R---------------------------`);
for (const Employee of arrayEmployee) {
...
console.log(`4.-------------------Employee Salary Greater than 70000---------------------------`);
for (const Employee of arrayEmployee) {
...
console.log(`5.-------------------Employee Salary Greater than 50000 & IT---------------------------`);
for (const Employee of arrayEmployee) {
...
console.log(`6.-------------------Employee From Tnfy---------------------------`);
