...
console.log("____________________Travers the map and log the details of Employees____________________________________________________");
...
map_employees.forEach((key,values) => {
console.log(`Employee ID: ${values}===> `, key);
